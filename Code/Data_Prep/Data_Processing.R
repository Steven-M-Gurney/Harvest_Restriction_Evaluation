...
# This script was used to process count data for each sex-and-age class individually.
# Note when running each sex-and-age class, hardcoding is needed when loading data and saving output.
# Below is an example used for processing 2022 count data (same approach used for other years).
...
# The final output here were used as count data in the N-mixture models.
...
write.csv(final.2022does.freq.1.week, "Counts_Females_2022.csv", row.names=FALSE)
...
# Save final output for use in N-mixture model.
write.csv(final.2022allfawns.freq.1.week, "Counts_Fawns_2022.csv", row.names=FALSE)
...
# Save final output for use in N-mixture model.
write.csv(final.2022sublegal.freq.1.week, "Counts_Sublegal_2022.csv", row.names=FALSE)
...
# Save final output for use in N-mixture model.
write.csv(final.2022legal.freq.1.week, "Counts_Legal_2022.csv", row.names=FALSE)